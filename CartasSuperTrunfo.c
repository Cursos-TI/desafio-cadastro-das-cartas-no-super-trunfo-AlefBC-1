...
int main() {
  ...
  float area1, pib1, densPop1, pibCap1;

  // Variáveis para a segunda carta
  char estado2, codigo2[5], cidade2[50];
  int populacao2, pontosTuristicos2;
  float area2, pib2, densPop2, pibCap2;
  ...
  scanf(" %f", &pib1);
  // calcular Densidade populacional carta 1
  densPop1 = (float)populacao1 / area1;
  // calcular Pib por Capita carta 1
  ...
  printf("Qual o PIB (em bilhões)?\n");
  scanf(" %f", &pib2);
   // calcular Densidade populacional carta 2
  densPop2 = (float)populacao2 / area2;
  
   // calcular Pib por Capita carta 2
